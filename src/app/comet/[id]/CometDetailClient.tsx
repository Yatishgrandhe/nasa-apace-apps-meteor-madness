...
export default function CometDetailClient({ cometId }: CometDetailClientProps) {
  ...
  const safeOrbitInfo = {
    ...orbitInfo,
    riskLevel: comet.is_potentially_hazardous_asteroid ? 'High' : 'Low' as 'Low' | 'Medium' | 'High'
  }
          ...
          <div className="flex items-center justify-center space-x-4">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-4 mt-2">
                ...
                <span className="text-sm text-gray-300">
                  Risk Level: <span className={`font-semibold ${safeOrbitInfo.riskLevel === 'High' ? 'text-red-400' : safeOrbitInfo.riskLevel === 'Medium' ? 'text-yellow-400' : 'text-blue-400'}`}>
      ...
      {latestApproach ? (
        <div className="bg-black/40 backdrop-blur-sm border border-cyan-500/30 rounded-xl p-6 shadow-lg glow-blue">
          <h3 className="text-xl font-semibold text-cyan-400 mb-4 flex items-center space-x-2">
            ...
            <span>
              {latestApproach.close_approach_date && new Date(latestApproach.close_approach_date) > new Date() 
